...
def driver_fn(walks,user_checkins, user_checkins_counter, embs_ini, learning_rate, K_neg,
    ...
    emb_n = learn(walk, num_w, num_wl, user_checkins, user_checkins_count, emb_n, num_n, dim_emb, starting_alpha, num_neg, neg_sam_table_social,table_size_social, win_size, neg_sam_table_mobility1,table_size_mobility1,neg_sam_table_mobility2,table_size_mobility2,neg_sam_table_mobility3,
table_size_mobility3,neg_sam_table_mobility4,table_size_mobility4,num_epoch, mobility_ratio)
    return(emb_n)
